  ...
  return (
    <>
      {isMobile ? (
        ...
        >
          <div className="mx-3 flex h-full flex-col rounded-xl shadow-lg shadow-gray-400/40 overflow-hidden">
            <div className="flex h-full flex-col rounded-xl shadow shadow-gray-800/50 overflow-hidden">
              {children}
            </div>
          </div>
        </div>
